  ...
  create view "dbt_tut"."april_tut"."applicant_challenges__dbt_tmp" as (
    WITH 
  applicants AS (SELECT * FROM "dbt_tut"."april_tut"."applicants" ),
  seed_challenges AS ( SELECT * FROM "dbt_tut"."april_tut_seeds"."challenges" ),
